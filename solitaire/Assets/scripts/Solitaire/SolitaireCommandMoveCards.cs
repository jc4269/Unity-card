...
public class SolitaireCommandMoveCards : ICommand
{
    ...
    public SolitaireCommandMoveCards(List<GameObject> cardsToMove, GameObject fromCardStack, GameObject toCardStack)
    {
